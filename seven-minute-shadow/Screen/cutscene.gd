...
func _create_intro() -> void:
	...
	_intro_background.position = Vector2.ZERO
	_intro_background.size = viewport_size
	_intro_background.mouse_filter = Control.MOUSE_FILTER_IGNORE
	...
	_intro_text.bbcode_enabled = false
	_intro_text.scroll_active = false
	_intro_text.mouse_filter = Control.MOUSE_FILTER_IGNORE
	...
	_intro_continue.horizontal_alignment = HORIZONTAL_ALIGNMENT_RIGHT
...
func _start_actual_cutscene() -> void:
